...
def _attn_fwd_inner(acc, l_i, m_i, q,  #
    ...
    # for start_n in range(lo, hi, BLOCK_N):
        ...
        if last_blk == 0 or IS_DENSEBLK == 0: ## This is general case
            ...
            binaryBlk_val = tl.cast(0, tl.float16) ## THe cast was required for correct compilation
...
def _attn_bwd_dkdv(dk, dv,  #
    ...
    for blk_idx in range(num_steps):
        ...
        if last_blk == 0 or IS_DENSEBLK == 0:
            ...
            binaryBlk_val = tl.cast(0, tl.float16)
...
class _attention_combined_wo_binBlkMask(torch.autograd.Function):
    '''
...
attention_combined_wo_binBlkMask = _attention_combined_wo_binBlkMask.apply