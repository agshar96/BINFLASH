...
@triton.jit
def _attn_fwd(Q, K, V, sm_scale, M, Out, maskMat, #
...
class _attention_bcwrd_masked(torch.autograd.Function):

    @staticmethod
    def forward(ctx, q, k, v, causal, sm_scale, maskMat):
        # shape constraints
        ...
        ctx.save_for_backward(q, k, v, o, M, maskMat)
        ctx.grid = grid
    ...
    @staticmethod
    def backward(ctx, do):
        q, k, v, o, M, maskMat = ctx.saved_tensors
...
attention_masked = _attention_bcwrd_masked.apply