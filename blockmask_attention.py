...
def _attn_fwd(Q, K, V, sm_scale, M, Out, maskMat, blkBinaryMask, #
    ...
    # t_size = N_CTX // BLOCK_N
    # binaryBlk_row = tl.zeros((32,), dtype=tl.float32) + 1.0
    # stage 1: off-band
...
class _attention_binaryBlkMat(torch.autograd.Function):
...
attention_binaryBlkMat = _attention_binaryBlkMat.apply